...
var Models = (function () {
    ...
    Models.prototype.get = function (key) {
        return this._model[key];
    };
    Models.prototype.set = function (key, value) {
        this.trigger("set", { name: key, value: value });
        return this._model[key] = value;
    };
    Models.prototype.hasProperty = function (key) {
        return !_.isUndefined(this._model[key]);
    };
    Models.prototype.on = function (eventName, handler) {
        if (_.isUndefined(this._events[eventName])) {
            return this._events[eventName] = [handler];
        }
        this._events[eventName].push(handler);
    };
    Models.prototype.off = function (eventName) {
        delete this._events[eventName];
    };
    Models.prototype.trigger = function (eventName, eventParams) {
    ...
    Models.prototype._unsetCollection = function () {
        this._model["collection"] = {};
    };
    Models.prototype._setCollection = function (collection) {
...
var Collections = (function () {
    ...
    Collections.prototype._init = function (array) {
        var _this = this;
        array.forEach(function (object) {
            if (object instanceof Models_1.Models) {
                object._setCollection(_this);
                return _this._models[object.get("l_id")] = object;
            }
            var model = new Models_1.Models(object);
            model._setCollection(_this);
            _this._models[model.get("l_id")] = model;
        });
    };
    Collections.prototype.add = function (model) {
    ...
    Collections.prototype.remove = function (model) {
        if (!_.isUndefined(this._models[model.get("l_id")])) {
    ...
    Collections.prototype.on = function (eventName, handler) {
        if (_.isUndefined(this._events[eventName])) {
            return this._events[eventName] = [handler];
        }
        this._events[eventName].push(handler);
    };
    Collections.prototype.has = function (model) {
        return !_.isUndefined(this._models[model.get("l_id")]);
    };
    Collections.prototype.off = function (eventName) {
        delete this._events[eventName];
    };
    Collections.prototype.trigger = function (eventName, eventParams) {
        if (eventParams === void 0) { eventParams = {}; }
        if (!_.isUndefined(this._events[eventName])) {
            this._events[eventName].forEach(function (handler) {
                handler(eventParams);
    ...
    Collections.prototype.clear = function () {
        ...
        Object.keys(this._models).forEach(function (key) {
            _this._models[key]._unsetCollection();
...
/***/ })
/******/ ]);
//# sourceMappingURL=lanurite.js.map